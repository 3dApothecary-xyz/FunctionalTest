...
# Execute with "curl -s https://raw.githubusercontent.com/3dApothecary-xyz/FunctionalTest/refs/heads/main/scripts/ftcanload1.sh | bash"

expectedNetworkdResponse="  systemd-networkd.service                                                                                                                       loaded    active running   Network Configuration
...
echo -e "\"$networkdResponse\""

if [[ "$networkdResponse" != "$expectedNetworkdResponse" ]]; then
  echo -e "  "
